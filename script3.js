...
function login(){
    ...
    let bancoDeDados = JSON.parse(localStorage.getItem("bancoDeDados")); //converte o objeto para json
if (bancoDeDados == null) {
    ...
    for (let usuario of bancoDeDados) {
        if (usuario.login == login && usuario.senha == senha) {
            ...
            localStorage.setItem("logado", JSON.stringify(usuario)); //converte objeto para cadeia de caracteres
